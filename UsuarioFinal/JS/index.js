...
function cargarMateriales(idTema){
    ...
    for(var i = 0; i < Materiales.length ; ++i){
        ...
        console.log(Materiales[i][1]); //idTemario                        //idTemario
        ...
        success: function(response){
            ...
            tipos.forEach((element)=>{
                if(element.idTemario == id){
                    ...
                    inputt.value = element.nombreTema;
                    inputt.setAttribute("onClick", `cargarMateriales(${element.idTema})`);
        ...
        success: function(response){
            ...
            tipos.forEach((element)=>{
                ...
                div.innerHTML = `<div class="uea">
                                    ...
                                    onClick="cargarTemas(${element.idTemario},'${element.nombreTemario}');">
                                    <p>
                                        ${element.clave}
                                        <br>
                                        ${element.descripcion}
