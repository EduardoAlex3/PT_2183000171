<?php
    ...
    // function recuperarPDFs(){
    //     include "conexion.php";
    //     $query = "SELECT idTemario, idTema, material.Nombre as nombreMaterial, material.URL from tema 
    //     inner join material_has_tema on tema.idTema = material_has_tema.tema_idTema 
    //     inner join material on material_has_tema.material_idMaterial = material.idMaterial 
    //     inner join temario on tema.Temario_idTemario = temario.idTemario
    //     where tipomaterial_idTipoMaterial = 1;";
    //     $result = mysqli_query($conn,$query);
    //     $json = array();
    //     while($row = mysqli_fetch_array($result)){
    //         $json [] = array(
    ...
    //     return $json;
    // }
    // function recuperarVideos(){
    //     include "conexion.php";
    //     $query = "SELECT idTemario, idTema, material.Nombre as nombreMaterial, material.URL from tema 
    //     inner join material_has_tema on tema.idTema = material_has_tema.tema_idTema 
    //     inner join material on material_has_tema.material_idMaterial = material.idMaterial 
    //     inner join temario on tema.Temario_idTemario = temario.idTemario
    //     where tipomaterial_idTipoMaterial = 2;";
    //     $result = mysqli_query($conn,$query);
    //     $json = array();
    //     while($row = mysqli_fetch_array($result)){
    //         $json [] = array(
    ...
    //     return $json;
    // }
    // function recuperarLibros(){
    //     include "conexion.php";
    //     $query = "SELECT idTemario, idTema, material.Nombre as nombreMaterial, material.URL from tema 
    //     inner join material_has_tema on tema.idTema = material_has_tema.tema_idTema 
    //     inner join material on material_has_tema.material_idMaterial = material.idMaterial 
    //     inner join temario on tema.Temario_idTemario = temario.idTemario
    //     where tipomaterial_idTipoMaterial = 3;";
    //     $result = mysqli_query($conn,$query);
    //     $json = array();
    //     while($row = mysqli_fetch_array($result)){
    //         $json [] = array(
